...
def get_current_version(file_path):
    try:
        ...
        print(f"👉 Kontrollera att mappen 'custom_components/battery_optimizer_light' finns.")
        sys.exit(1)
...
def main():
    ...
    print(f"☁️  Pushar commit och taggar...")
